package com.example.absensi.views.changepass
...
import com.example.absensi.model.ChangePasswordResponse
...
class ChangePasswordActivity : AppCompatActivity() {
    ...
    private fun checkValidation(oldPass: String, newPass: String, confirmNewPass: String): Boolean {
        when {
            oldPass.isEmpty() -> {
                binding.etOldPassword.error = getString(R.string.please_fill_your_password)
                binding.etOldPassword.requestFocus()
            }
            newPass.isEmpty() -> {
                binding.etNewPassword.error = getString(R.string.please_fill_your_password)
                binding.etNewPassword.requestFocus()
            }
            confirmNewPass.isEmpty() -> {
                binding.etConfirmNewPassword.error = getString(R.string.please_fill_your_password)
